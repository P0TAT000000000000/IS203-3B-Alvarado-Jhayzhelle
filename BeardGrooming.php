...
<br>
<br>
<h1 class="title">Here  are  the  reference  for  the  different  types  of  Beard Grooming.</h1>

<div id="app" class="container">
  <card data-image="images/BeardTrims.jpg">
    <h1 slot="header">Beard Trims</h1>
    <p slot="content">Trimming a beard gives it shape, A beard without a shape is just hair protruding from the face. If you follow the proper way to trim a beard, you'll be aiming for an even length all over, with a proper beard neckline, cheekline, mustache and lipline.</p>
  </card>
  <card data-image="images/BeardTrims2.jpg">
    <h1 slot="header">Beard Shaping</h1>
    <p slot="content">The process of grooming and styling a beard to achieve a desired shape, symmetry, and overall appearance. It involves the careful trimming, sculpting, and shaping of facial hair to create clean lines, defined contours, and a well-maintained look.</p>
  </card>
  <card data-image="images/FullBeardGrooming.jpg">
    <h1 slot="header">Full Beard Grooming</h1>
    <p slot="content">It consists of a beard, moustache and whiskers, which will grow together to cover your cheeks, chin and neck – making this beard style suitable for any face shape. Impressively masculine, with minimum sculpting required, it's rightly named the king of beards. </p>
  </card>
  <card data-image="images/LineUps.jpg">
    <h1 slot="header">Line-ups</h1>
    <p slot="content"> In essence, a beard lineup is the precise grooming of the edges and contours of your beard, which defines and sharpens its appearance.</p>
  </card>
</div>
