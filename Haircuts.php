...
<br>
<br>
<h1 class="title">Here  are  the  reference  for  the  different  types  of  haircut.</h1>

<div id="app" class="container">
  <card data-image="images/Classiccut.jpg">
    <h1 slot="header">Classic Cut</h1>
    <p slot="content">The classic cut is defined as shorter hair on top with longer hair on the sides. It does not use a fading technique, which is why this is a good choice for the more conservative man.</p>
  </card>
  <card data-image="images/Buzzcut.jpg">
    <h1 slot="header">Buzz Cut</h1>
    <p slot="content">Buzz cuts are not only fashionable but also practical. With minimal upkeep required, they offer convenience and ease, which many girls find attractive.</p>
  </card>
  <card data-image="images/Tapercut.jpg">
    <h1 slot="header">Taper Cut</h1>
    <p slot="content">A Taper haircut typically starting out longer at the top of the head and getting shorter as you go down to the natural hairline on the nape of the neck and sides of the head.</p>
  </card>
  <card data-image="images/Undercut.jpg">
    <h1 slot="header">Under Cut</h1>
    <p slot="content">Having an undercut emphasizes hair volume and shows off your facial structure. <br><br>Whether your hair is straight, wavy, or permed.</p>
  </card>
  <card data-image="images/TaperFadecut.jpg">
    <h1 slot="header">Fade Cut</h1>
    <p slot="content">A fade haircut involves fading the length of the hair from the top of the head down to the sides and nape of the neck. The fade can either blend gradually or sharply from long to short. </p>
  </card>
</div>
